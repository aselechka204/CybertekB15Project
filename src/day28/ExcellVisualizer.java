...
public class ExcellVisualizer {
  ...
  Cell(6,1)= 67    Cell(6,2)= 33    Cell(6,3)= 98    Cell(6,4)= 34
        ...
        //to store this in 1 object

        int[][] sheet= new int[][]{ row1, row2, row3, row4, row5, row6 };
      //                    0   1      0    1   2      0   1
        int[][] sheet1= { {10, 27  },{ 87, 99, 100 },{90, 45} };
     ///      object count    0             1            2
        ...
        System.out.println(sheet1.length); // gives up object count
        // how many item do i have in the first item of this 2d array
        System.out.println(Arrays.toString(sheet1[0])); // seeing whats inside first 1 d array

        System.out.println(sheet1[0].length); // getting he length of the 1d array
        ...
        for (int i = 0; i <sheet1.length ; i++) {
                ...
                System.out.println("Item number "+ i + " length is: "+sheet1[i].length);
            }
